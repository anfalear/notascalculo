...
\begin{definition}\index{transformada de Laplace}
...
\begin{definition}[Orden exponencial]\index{orden exponencial}
...
\begin{theorem}[Condiciones suficientes de existencia]\index{transformada de Laplace!existencia}
...
\begin{theorem}[Linealidad]\index{transformada de Laplace!linealidad}
...
\begin{theorem}[Primer teorema de traslación (desplazamiento en $s$)]\index{traslacion, primer teorema de@traslación, primer teorema de}
...
\begin{theorem}[Transformada de derivadas]\index{transformada de Laplace!de derivadas}
...
\begin{theorem}[Transformada de integrales]\index{transformada de Laplace!de integrales}
...
\begin{theorem}[Derivada de la transformada (multiplicación por $t$)]\index{transformada de Laplace!derivada de la transformada}
Si $F(s)=\mathcal{L}\{f(t)\}$, entonces
\[
...
\begin{theorem}[División por $t$]\index{transformada de Laplace!division por $t$@división por $t$}
...
\begin{definition}\index{transformada de Laplace!inversa}
...
\begin{definition}[Escalón unitario]\index{escalon unitario@escalón unitario}
...
\begin{theorem}[Segundo teorema de traslación (desplazamiento en $t$)]\index{traslacion, segundo teorema de@traslación, segundo teorema de}
Si $\mathcal{L}\{f(t)\}=F(s)$, entonces
\[
...
\begin{definition}[Delta de Dirac]\index{delta de Dirac}
...
\begin{theorem}[Transformada de la delta]\index{delta de Dirac!transformada}
Para $a\ge0$,
\[
...
\begin{definition}\index{convolucion@convolución}
...
\begin{theorem}[Teorema de convolución]\index{convolucion@convolución!teorema de}
