...
% [Original: líneas 1766-1770 | sin verificar | sin figura | 2 variante(s) de parámetro (se descartaron 1)]
\begin{prob}
Use coordenadas cilíndricas para evaluar la integral 
\[ \displaystyle\int_{0}^{4}\int_{0}^{2}\int_{0}^{\sqrt{4-x^2}}\ \left(x^2+y^2\right)\ dy\ dx\ dz\]
Exprese claramente los límites de integración correspondientes y la solución de la integral.
\end{prob}

% [Original: líneas 1876-1880 | sin verificar | sin figura]
\begin{prob}
Use coordenadas cilíndricas para evaluar la integral 
\[ \displaystyle\int_{0}^{2}\int_{0}^{10}\int_{0}^{\sqrt{100-x^2}}\ \left(x^2+y^2\right)\ dy\ dx\ dz\]
Exprese claramente los límites de integración correspondientes y la solución de la integral.
\end{prob}
...
\begin{prob}
Use coordenadas esféricas para determinar el valor de la integral triple $$\displaystyle\int\int\int_{\Omega}5z\  dV,$$ donde $\Omega$ es la región $$\Omega=\left\lbrace (x,y,z)\in \mathbb{R}^3 : x^2+y^2+z^2 \leq 4,\ z\geq 0,\ z^2\geq x^2+y^2 \right\rbrace.$$ \textbf{Respuesta:} $\approx 31.41592$.
\end{prob}
...
% [Original: líneas 1757-1764 | sin verificar | sin figura | 2 variante(s) de parámetro (se descartaron 1)]
\begin{prob}
Una lámina cuya densidad está determinada por la función $\rho(x,y)=13x+5y+3$ tiene la forma de una región triangular cuyos vértices son los puntos $(0,0),$ $(4,4)$ y $(4,0).$ De acuerdo a la información dada:
\begin{enumerate}[(a)] 
\item Realice la gráfica de la lámina.
\item Use integrales dobles para determinar la masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
\item Use integrales dobles para determinar el centro de masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
...
% [Original: líneas 1823-1830 | sin verificar | sin figura]
\begin{prob}
Una lámina cuya densidad está determinada por la función $\rho(x,y)=14y+2$ tiene la forma de una región triangular cuyos vértices son los puntos $(0,0),$ $(2,2)$ y $(2,0).$ De acuerdo a la información dada:    
\begin{enumerate}[(a)] 
\item Realice la gráfica de la lámina.
\item Use integrales dobles para determinar la masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
\item Use integrales dobles para determinar el centro de masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
...
% [Original: líneas 1845-1852 | sin verificar | sin figura]
\begin{prob}
Una lámina cuya densidad está determinada por la función $\rho(x,y)=2x+y+13$ tiene la forma de una región triangular cuyos vértices son los puntos $(0,0),$ $(2,2)$ y $(2,0).$ De acuerdo a la información dada:
\begin{enumerate}[(a)] 
\item Realice la gráfica de la lámina.
\item Use integrales dobles para determinar la masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
\item Use integrales dobles para determinar el centro de masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
...
% [Original: líneas 1867-1874 | sin verificar | sin figura]
\begin{prob}
Una lámina cuya densidad está determinada por la función $\rho(x,y)=2x+13$ tiene la forma de una región triangular cuyos vértices son los puntos $(0,0),$ $(10,10)$ y $(10,0).$ De acuerdo a la información dada:
\begin{enumerate}[(a)] 
\item Realice la gráfica de la lámina.
\item Use integrales dobles para determinar la masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
\item Use integrales dobles para determinar el centro de masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
...
% [Original: líneas 2280-2287 | sin verificar | sin figura]
\begin{prob}
Una lámina cuya densidad está determinada por la función $\rho(x,y)=5x+2y$ tiene la forma de una región triangular cuyos vértices son los puntos $(0,0),$ $(6,6)$ y $(6,0).$ De acuerdo a la información dada:
\begin{enumerate}[(a)] 
\item Realice la gráfica de la lámina.
\item Use integrales dobles para determinar la masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
\item Use integrales dobles para determinar el centro de masa de la lámina. Exprese claramente los límites de integración correspondientes y la solución de la integral.
...
% [Original: líneas 2323-2325 | sin verificar | sin figura]
\begin{prob}
Demuestre que las áreas superficiales de los paraboloides $x^2+y^2=8z$ y $x^2-y^2=8z$ sobre la región $R=\left\lbrace (x,y):\ x^2+y^2\leq 25 \right\rbrace$ miden lo mismo. Calcule tal área. 
\end{prob}
...
% [Original: líneas 1496-1520 | sin verificar | PSTRICKS - pendiente convertir a tikz | 2 variante(s) de parámetro (se descartaron 1)]
\begin{prob}
Considere la región $R$ (ver figura \ref{fig2.1}), la cual está limitada por las curvas $y=x+4,$ $y=-(x+3)^2+1,$ $y=-8+4x,$ $y=(x-2)^2.$ Plantee la integral doble que permite calcular el área encerrada por estas curvas y determine el valor de esta área.
\begin{figure}[H]\centering
...
\end{tikzpicture}
\caption{Región del primer ejercicio}\label{fig2.1}
\end{figure}
\end{prob}

% [Original: líneas 1538-1562 | sin verificar | PSTRICKS - pendiente convertir a tikz | 2 variante(s) de parámetro (se descartaron 1)]
\begin{prob}
Considere la región $R$ (ver figura \ref{fig3.1}), la cual está limitada por las curvas $y=2(x+2)^2,$ $y=-4-2x,$ $y=-8+4x,$ $y=-(x-2)^2.$ Plantee la integral doble que permite calcular el área encerrada por estas curvas y determine el valor de esta área.
\begin{figure}[H]\centering
\begin{tikzpicture}[scale=0.45]
  ...
  \fill[red] (0,8) circle (3pt); \fill[red] (2,0) circle (3pt);
\end{tikzpicture}
\caption{Región del primer ejercicio}\label{fig3.1}
\end{figure}
\end{prob}
...
% [Original: líneas 1964-1986 | sin verificar | PSTRICKS - pendiente convertir a tikz]
\begin{prob}
Considere la región $R$ (ver la figura), la cual está limitada por las curvas $y=x+6,$ $y=-x^2-4x,$ $y=x,$ $y=-x^2+6.$ 
\begin{enumerate}[(a)]
\item Plantee la integral doble que permite calcular el área encerrada por estas curvas. Defina claramente los límites de integración.
\item Evalúe la integral que obtuvo en el paso anterior. Muestre explícitamente todos los cálculos necesarios para obtener el área.
\end{enumerate}
...
% [Original: líneas 1898-1900 | sin verificar | sin figura]
\begin{prob}
Considere el campo vectorial ${\bf F}=\left( 6xy^3+2z^2  \right){\bf i}+\left( 9x^2y^2 \right){\bf j}+\left( 4xz+1  \right){\bf k}.$ Determine si es un campo vectorial conservativo, y si lo es calcule su función potencial.
\end{prob}

% [Original: líneas 1902-1904 | sin verificar | sin figura]
\begin{prob}
Calcule la integral $\displaystyle\int_{C}(8x+36z)\ ds$ donde $C$ es la curva $x=t,$ $y=t^2,$ $z=t^3$ con $0\leq t\leq 2.$
\end{prob}

% [Original: líneas 1906-1908 | sin verificar | sin figura]
\begin{prob}
...
% [Original: líneas 2343-2345 | solo respuesta final | sin figura]
\begin{prob}
Calcule  la  integral triple $$\displaystyle\int\int\int_{\Omega}x^2\  dV,$$ donde $\Omega$ es la región acotada por las curvas $x^2+z=1,$  $y^2+z=1$ y el plano $xy$. \textbf{Respuesta:} $\approx 0.6667$.
\end{prob}

% [Original: líneas 2369-2371 | solo respuesta final | sin figura]
\begin{prob}
Calcule  la  integral triple $$\displaystyle\int\int\int_{\Omega}z\  dV,$$ donde $\Omega$ es la región acotada por las curvas $x^2+z=1,$  $y^2+z=1$ y el plano $xy$. \textbf{Respuesta:} $\approx 0.66667$.
\end{prob}
