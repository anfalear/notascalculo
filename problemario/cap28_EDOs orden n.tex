...
\begin{definition}\index{ecuacion diferencial lineal de orden $n$@ecuación diferencial lineal de orden $n$}
...
\begin{theorem}[Principio de superposición]\label{thm:cap28:superposicion}\index{principio de superposicion@principio de superposición}
...
\begin{definition}\index{conjunto fundamental de soluciones}
...
\begin{theorem}[Criterio de independencia lineal]\label{thm:cap28:wronskiano}\index{wronskiano}
...
\begin{theorem}[Estructura de la solución general]\label{thm:cap28:estructura}\index{ecuacion diferencial lineal de orden $n$@ecuación diferencial lineal de orden $n$!estructura de la solucion@estructura de la solución}
...
\begin{theorem}[Casos de las raíces]\index{ecuacion caracteristica@ecuación característica}
\begin{enumerate}
...
\begin{definition}[Tabla de formas de $y_p$]\index{coeficientes indeterminados}
\begin{center}
\begin{tabular}{c|c}
...
\begin{theorem}[Casos]\index{Cauchy-Euler, ecuacion de@Cauchy-Euler, ecuación de}
\begin{enumerate}
