...
\begin{theorem}[Teorema de Pitágoras]\index{Pitágoras, teorema de}
...
\begin{definition}[Proyección ortogonal]\index{proyección ortogonal}
...
\begin{theorem}[Expansión en base ortogonal]\index{base (espacio vectorial)!ortogonal, expansión}
...
\begin{theorem}[Descomposición ortogonal]\index{descomposición ortogonal}
...
\begin{definition}[Aproximación por mínimos cuadrados]\index{mínimos cuadrados}
...
\begin{theorem}[Mejor aproximación]\index{mínimos cuadrados!mejor aproximación}
...
\begin{theorem}[Ecuaciones normales]\index{mínimos cuadrados!ecuaciones normales}
...
\begin{theorem}[Solución única]\index{mínimos cuadrados!solución única}
...
\begin{theorem}[Fórmula de Euler]\label{demformeuler}\index{Euler, fórmula de}
