...
**Estado al 2026-06-25 (CIERRE TOTAL):** Decisiones arquitectónicas A–D resueltas. Muestreo Ej/Teo V1–V3 cerrado: 12/12. Prob14 (`cap30`, Hermite n=1) corregido: la solución polinomial es $y=a_1 x$ (serie impar, a₀=0), no $y=a_0(1-2x^2)$ (que es n=2). Verificado $y=x \Rightarrow 0-2x+2x=0$. $H_1(x)=2x$. **No hay ningún pendiente de verificación, matemático, ni arquitectónico.**
