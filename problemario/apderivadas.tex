...
\begin{definition}\index{extremos!absolutos}
...
\begin{itemize}
    ...
    \end{itemize}
  \end{definition}
  \begin{definition}\index{punto critico@punto crítico} Se dice que $c$ es un \textbf{punto crítico} de $f$ si es un punto interior
...
\begin{theorem}[Fermat]\index{Fermat, teorema de}
...
\begin{theorem}[Criterio de monotonía]\index{criterio de monotonia@criterio de monotonía}
...
\begin{definition}\index{concavidad}
...
\begin{definition}\index{extremos!locales}
...
\begin{theorem}[Criterio de la primera derivada]\index{extremos!criterio de la primera derivada}
...
\begin{theorem}[Criterio de la segunda derivada]\index{extremos!criterio de la segunda derivada}
...
\begin{theorem}[del Valor Medio de Lagrange]\index{teorema del valor medio!de Lagrange}
...
\begin{theorem}[Regla de L'Hôpital]\index{L'Hopital, regla de@L'Hôpital, regla de}
...
\begin{theorem}[Convergencia del punto fijo]\index{punto fijo!convergencia}
...
\begin{definition}\index{diferencial}
...
\begin{theorem}[Aproximación lineal o linealización]\index{linealizacion@linealización}
