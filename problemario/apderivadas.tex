...
\]
El bosquejo de la función puede revisarse nuevamente en la figura \ref{x4+3x3}.
\end{myproof}
\end{example}
...
\begin{example}[Aproximación lineal de $\sin 31^\circ$]
Usar la aproximación lineal para estimar $\sin 31^\circ$.
\begin{myproof}
\textbf{Paso 1. Elegir el punto base.}

Se trabaja en radianes: $31^\circ = \dfrac{31\pi}{180}$ rad, cercano
a $a=\dfrac{\pi}{6}$ ($=30^\circ$), para el que $\sin\dfrac{\pi}{6}=\dfrac{1}{2}$
es exacto.
...
\[
\sin 31^\circ \approx \frac{1}{2}+\frac{\sqrt{3}}{2}\cdot\frac{\pi}{180}
\approx 0.5000 + 0.0151 = \boxed{0.5151}.
\]
El valor exacto es $\sin 31^\circ\approx 0.5150\ldots$; error menor que $0.0001$.
\end{myproof}
\end{example}
