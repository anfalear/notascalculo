...
\begin{definition}[Campo vectorial]\index{campo vectorial}
...
\begin{definition}[Continuidad y diferenciabilidad de un campo vectorial]\index{campo vectorial!continuidad y diferenciabilidad}
...
\begin{definition}[Campo vectorial gradiente]\index{campo vectorial!gradiente}
...
\begin{definition}[Campo vectorial conservativo]\index{campo vectorial!conservativo}
...
\end{figure}
\begin{theorem}[Caracterización de campos conservativos en el plano]\index{campo vectorial!conservativo, caracterizacion en el plano@conservativo, caracterización en el plano}
...
\begin{definition}[Integral de línea sobre un campo escalar]\index{integral de linea@integral de línea!de un campo escalar}
...
\begin{theorem}[Teorema de evaluación para integral de línea de campo escalar]\index{integral de linea@integral de línea!teorema de evaluacion@teorema de evaluación}
Sea \(C\) una curva suave en \(\mathbb{R}^2\) parametrizada por
...
\begin{definition}[Integral de línea de un campo vectorial]\index{integral de linea@integral de línea!de un campo vectorial}
...
\begin{definition}[Campo conservativo]\index{campo vectorial!conservativo}
...
\begin{theorem}[Independencia de la trayectoria]\index{independencia de la trayectoria}
...
\begin{theorem}[Teorema fundamental de las integrales de línea]\index{teorema fundamental de las integrales de linea@teorema fundamental de las integrales de línea}
