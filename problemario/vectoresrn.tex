...
Por tanto, el volumen del paralelepípedo es $V=\abs{-80}=\boxed{80}$ unidades cúbicas.
...
Multiplicando por $5$, las ecuaciones simétricas son $\boxed{\frac{x+2}{-44}=\frac{y-1}{-15}=\frac{z+3}{-22}}.$
\end{myproof}
\end{example}
