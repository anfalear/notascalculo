...
| F9C1.20 | `tecintegracion.tex` | Heading + huérfanos + nota dependencia | Pendiente | — | Nota editorial integral definida |
| F9C1.21 | `intdefinida.tex` | Riemann + TFC + 5 center | Pendiente | — | — |
| F9C1.22 | `intdefinida.tex` | Tags + heading | Pendiente | — | — |
| F9C1.23 | `apintegral.tex` | Center lote 1 (~13) | Pendiente | — | — |
| F9C1.24 | `apintegral.tex` | Center lote 2 (~13) | Pendiente | — | — |
| F9C1.25 | `apintegral.tex` | Auditoría 17 residuales | Pendiente | — | — |
| F9C1.26 | `apintegral.tex` | Tags banco 41 | Pendiente | — | — |
| F9C1.27 | `impropias.tex` | Anidar 7 myproof (bug estructural total) | Pendiente | — | — |
