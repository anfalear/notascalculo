...
\begin{tikzpicture}[scale=1.35]
    ...
    \draw[blue!70!black,thick,->]
        (2.8,1.8) ..controls (2.3,2.5) and (0.9,2.6).. (0.6,1.8)
                  ..controls (0.2,1.1) and (0.7,0.3).. (1.5,0.4);
    \node[blue!70!black] at (2.9,0.7){\small $C$};
    \node at (1.6,1.45){\small $R$};
    \node[blue!70!black,font=\small] at (1.6,2.85){orientación $+$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.2]
  ...
  % Labels
  \node at (-0.5,0.4) {$R$};
  \node[blue!70!black] at (2.62,0.5) {$C$};
...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[red!70!black, scale=0.78] at (2.0, 0.26) {\small se cancelan};
  ...
  % Labels
  \node[blue!50!black] at (1.0, 2.35) {$Q$};
...
\begin{tikzpicture}[scale=1.1]
  ...
  % Labels
  \node[green!40!black] at (0.3,-0.2) {$S$};
  \node[red!70!black, below] at (0,-1.6) {\small $\partial S$};
  \node[gray!55, scale=0.82] at (-1.6,-0.7) {\small micro-circulaciones};
