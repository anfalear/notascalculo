\chapter{Integral de superficie, teorema de la divergencia y de Stokes}
\label{ch:superficies}
...
\textbf{Primeros momentos.}
Por simetría del dominio y de la densidad, $\bar{x}=\bar{y}=\bar{z}$. Calculemos $M_{xy}$:
\[
...
\]
La integral en $\phi$ es $\frac{1}{3}$. Luego $M_{xy} = \frac{\pi R^4}{6}$.

\textbf{Centro de masa.}
\[
\bar{z} = \frac{M_{xy}}{m} = \frac{\pi R^4/6}{\pi R^3/4} = \frac{4R}{6} = \frac{2R}{3}.
\]
Por simetría, $\bar{x}=\bar{y}=\bar{z}=\frac{2R}{3}$.
\[
\boxed{m = \frac{\pi R^3}{4}, \qquad (\bar{x},\bar{y},\bar{z}) = \left(\frac{2R}{3},\frac{2R}{3},\frac{2R}{3}\right)}
\]
\end{myproof}
...
= \iiint_Q (x+2z)\,dV.
\]
Por simetría, $\iiint_Q x\,dV = 0$ (la región es simétrica respecto al plano $x=0$ y el integrando $x$ es impar). Luego solo queda $2\iiint_Q z\,dV$.
