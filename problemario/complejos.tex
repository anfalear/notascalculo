...
\begin{definition}[Número complejo]\index{número complejo}
...
\begin{definition}[Operaciones básicas]\index{número complejo!operaciones básicas}
...
\begin{theorem}[Propiedades de campo de los números complejos]\index{número complejo!propiedades de campo}
...
\begin{definition}[Módulo y argumento]\label{modnumcom}\index{número complejo!módulo y argumento}
...
\begin{theorem}[Fórmula de Euler]\label{formeuler}\index{Euler, fórmula de} Para cualquier número real $\theta$:
$$\mathrm{e}^{i\theta}=\cos \theta + i \sen \theta.$$
\end{theorem}

\begin{definition}[Forma polar]\index{número complejo!forma polar}
...
\begin{theorem}[Multiplicación y división en forma polar]\index{número complejo!forma polar!multiplicación y división}
...
\begin{definition}[Raíz de un polinomio]\index{polinomio!raíz}
...
\begin{theorem}[Teorema Fundamental del Álgebra]\label{tfam}\index{teorema fundamental del álgebra}
...
\begin{theorem}[Raíces conjugadas de un polinomio real]\label{thm:cap02:raicesconjugadas}\index{polinomio!raíces conjugadas}
