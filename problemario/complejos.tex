...
Verdadera si $z$ no es real; falsa si $z\in\mathbb{R}$.
Demostración: si $z$ no es real, las raíces $z\neq\overline{z}$ son complejas conjugadas no reales, lo que ocurre exactamente cuando $b^2-4ac<0$. En cambio, si $z\in\mathbb{R}$ entonces $z=\overline{z}$ y la afirmación falla: por ejemplo, $z=\overline{z}=1$ es raíz de $x^2-2x+1=0$, cuyo discriminante es $b^2-4ac=0$.
...
\[
\boxed{\begin{array}{c}
a)\ \text{V},\quad b)\ \text{F},\quad c)\ \text{V},\quad d)\ \text{V},\quad e)\ \text{V},\quad f)\ \text{V si } z\notin\mathbb{R},\quad g)\ \text{F},\\[2pt]
