...
\textbf{Paso 3.} Su representación geométrica es:
...
\textbf{Paso 3.} A continuación se muestra la gráfica de la región:
...
\textbf{Paso 4.} En cada caso, las cuatro raíces cuartas comparten el mismo módulo y sus argumentos difieren en $\frac{\pi}{2}$: quedan distribuidas uniformemente sobre una circunferencia centrada en el origen, como predice la fórmula de De Moivre.
\end{myproof}
\end{example}
...
Estos resultados confirman los cálculos realizados en los Ejemplos \ref{formageometrica54i} y \ref{formapolar54i}.
\end{myproof}
\end{prob}
