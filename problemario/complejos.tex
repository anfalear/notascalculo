...
\begin{definition}[Número complejo]\index{numero complejo@número complejo}
...
\begin{definition}[Operaciones básicas]\index{numero complejo@número complejo!operaciones basicas@operaciones básicas}
...
\begin{theorem}[Propiedades de campo de los números complejos]\index{numero complejo@número complejo!propiedades de campo}
...
\begin{definition}[Módulo y argumento]\label{modnumcom}\index{numero complejo@número complejo!modulo y argumento@módulo y argumento}
...
\begin{theorem}[Fórmula de Euler]\label{formeuler}\index{Euler, formula de@Euler, fórmula de} Para cualquier número real $\theta$:
$$\mathrm{e}^{i\theta}=\cos \theta + i \sen \theta.$$
\end{theorem}

\begin{definition}[Forma polar]\index{numero complejo@número complejo!forma polar}
...
\begin{theorem}[Multiplicación y división en forma polar]\index{numero complejo@número complejo!forma polar!multiplicacion y division@multiplicación y división}
...
\begin{theorem}[Potencias y raíces enésimas de un número complejo]\label{thm:cap02:demoivre}\index{De Moivre, teorema de} Sea $z=\abs{z}\mathrm{e}^{i\theta}$ un número complejo y $n$ un entero positivo, entonces:
\begin{enumerate}[$1.$]
...
\begin{definition}[Raíz de un polinomio]\index{polinomio!raiz@raíz}
...
\begin{theorem}[Teorema Fundamental del Álgebra]\label{tfam}\index{teorema fundamental del algebra@teorema fundamental del álgebra}
...
\begin{theorem}[Raíces conjugadas de un polinomio real]\label{thm:cap02:raicesconjugadas}\index{polinomio!raices conjugadas@raíces conjugadas}
